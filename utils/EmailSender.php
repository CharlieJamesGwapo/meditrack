...
class EmailSender {
    ...
    private function configureSMTP() {
        try {
            ...
            $this->mailer->Password = defined('SMTP_PASSWORD') ? SMTP_PASSWORD : 'rtegcvlllmtaxnin';
                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0" style="background-color: #ffffff; border-radius: 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); overflow: hidden;">
                    ...
                    <tr>
                        <td align="center" style="padding: 20px 30px 40px 30px;">
                            <a href="http://localhost/meditrack/pages/patient-dashboard.html" style="display: inline-block; background-color: #10b981; color: #ffffff; text-decoration: none; padding: 14px 32px; border-radius: 8px; font-size: 16px; font-weight: 600; box-shadow: 0 4px 6px rgba(16, 185, 129, 0.3);">
                                View My Dashboard
                            </a>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="background-color: #f9fafb; padding: 30px; text-align: center; border-top: 1px solid #e5e7eb;">
                            ...
                            <p style="margin: 0; color: #9ca3af; font-size: 12px;">
                                © 2025 MediTrack Hospital System. All rights reserved.
                            </p>
                        </td>
                    </tr>
...
http://localhost/meditrack/pages/patient-dashboard.html
